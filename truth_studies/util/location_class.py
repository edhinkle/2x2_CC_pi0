################################################################################
##                                                                            ##
##    CONTAINS: Methods related to ProtoDUNE-ND event location classification.##
##              Geometry definitions are copied straight from                 ##
## https://github.com/DUNE/2x2_sim/blob/main/validation/edepsim_validation.py ##
## Modified from: https://github.com/edhinkle/mesonless_numubarCC/blob/main/  ##
## common/geometry_defs.py##                                                  ##
##                                                                            ##
################################################################################
...
import sys
sys.path.append('../../')
import truth_studies.util.geometry_defs as geometry_defs
