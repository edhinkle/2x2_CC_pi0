...
def plot_hadrons(d, scale_factor, sig_bkg = 0):
    ...
    rasterize_plots()
    # DEFINE: Plotting hadron kinematics for signal or background events
    sample_type = ''
    sample_title = ''
    if sig_bkg == 0: 
    ...
    output_pdf_name = sample_type+"_events_hadron_kinematics.pdf"
