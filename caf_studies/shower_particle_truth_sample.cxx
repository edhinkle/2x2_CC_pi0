...
int shower_particle_truth_sample(const std::string& file_list, bool is_flat = true)
{
    ...
    for(unsigned long i = 0; i < nspills; ++i)
    {
        ...
        for(unsigned long ixn = 0; ixn < num_ixn; ++ixn)
        {
            ...
            if(true_ixn_pi0s < 1 && true_ixn_electrons < 1 && true_ixn_gammas < 1) {
                //std::cout << "No pi0s or showers in true interaction... skipping..." << std::endl;
                continue;
            }
