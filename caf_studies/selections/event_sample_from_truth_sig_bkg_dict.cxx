...
int event_sample_from_truth_sig_bkg_dict(const std::string& file_list, const std::string& json_file_path, bool is_flat = true)
{
...
//
    ...
    std::string file_name = "pi0_event_sample_from_truth_sig_bkg_dict";
